...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'Riet');
...
if( !function_exists('cbv_theme_setup') ){
    ...
    function cbv_theme_setup(){
      ...
      load_theme_textdomain( 'Riet', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            'cbv_main_menu' => __( 'Main Menu', 'Riet' ),
            'cbv_copyright_menu' => __( 'Copyright Menu', 'Riet' )
        ) );
...
if( function_exists('acf_add_options_page') ) { 
    ...
    acf_add_options_page(array(
        'page_title'    => __('Options', 'Riet'),
        'menu_title'    => __('Options', 'Riet'),
